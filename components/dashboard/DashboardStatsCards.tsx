        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            {cards.map((card, index) => {
                ...
                return (
                    <div
                        key={index}
                        className="group relative bg-card border border-border-default p-5 rounded-[0.5rem] shadow-sm"
                    >
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center justify-between mb-5">
                                <div
                                    className={`w-11 h-11 rounded-2xl flex items-center justify-center transition-all duration-500 group-hover:scale-110 shadow-sm ${card.bgClass}`}
                                >
                            ...
                            <div className="space-y-1.5">
                                <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em] leading-none mb-1 group-hover:text-text-secondary transition-colors">
                                    {card.label}
                                </p>
