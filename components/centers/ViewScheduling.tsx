          ...
          return (
            <button
              ...
              style={{
                ...
                backgroundColor: isDisabled ? colors.gray[400] + '20' : undefined
              }}
              className={`flex items-center gap-2 px-5 py-2.5 text-white rounded-xl shadow-lg transition-all font-bold text-sm ${isDisabled ? 'opacity-50 cursor-not-allowed grayscale' : 'hover:scale-[1.02] active:scale-[0.98]'}`}
