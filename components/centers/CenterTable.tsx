                                                ...
                                                <div className="min-w-0">
                                                    <div className="flex items-center gap-2">
                                                        <button
                                                            ...
                                                            className="text-base font-black text-text-primary hover:text-primary-600 dark:hover:text-primary-400 transition-colors truncate"
                                                        >
                                                            {center.center_name}
                                                        </button>
                                                        <span
                                                            className="lg:hidden px-2 py-0.5 text-[10px] font-black rounded-full"
                                                            style={{
