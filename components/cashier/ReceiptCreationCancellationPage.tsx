...
const ReceiptCreationCancellationPage: React.FC = () => {
    ...
    const fetchReceipts = async (type?: string | null) => {
        try {
                ...
                <div className="bg-card rounded-2xl border border-border-default p-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-bold text-text-primary">{receipts.length}</p>
                        </div>
                    </div>
                </div>
                <div className="bg-card rounded-2xl border border-border-default p-5">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[9px] text-text-muted font-medium">{r.customer?.nic || 'NO NIC'}</p>
                                            </div>
                                        </div>
                                    </td>
