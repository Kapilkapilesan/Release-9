...
export function SessionHistoryModal({ userId, userName, onClose }: SessionHistoryModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 animate-in fade-in duration-300">
            <div className="bg-card rounded-[2.5rem] shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300 border border-border-default/50">
                {/* Header */}
                <div className="px-8 py-6 border-b border-border-default flex items-center justify-between bg-table-header/30">
                    <div>
                ...
                {/* Content */}
                <div className="flex-1 overflow-y-auto p-8 bg-app-background/50">
                        ...
                        <>
                            ...
                            {activeTab === 'history' && (
                                <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-500">
                                    {/* Filters */}
                                    <div className="bg-card p-4 rounded-[2rem] border border-border-default mb-6 flex flex-wrap gap-4 items-end shadow-sm">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {history.length === 0 && (
                                            <div className="text-center py-16 bg-card rounded-[2.5rem] border-2 border-dashed border-border-default">
