                    ...
                    >
                        ...
                        <div className="grid grid-cols-12 gap-4 items-center">
                            ...
                            <div className="col-span-4 flex items-center gap-5">
                                <div className="w-12 h-12 bg-primary-500/10 border border-primary-500/20 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover/row:scale-110 transition-transform overflow-hidden">
