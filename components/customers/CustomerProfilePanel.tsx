            ...
            <div className="bg-card rounded-[2.5rem] shadow-2xl w-full max-w-md overflow-hidden flex flex-col h-fit border border-border-default">
                ...
                <div className={`${isBlocked ? 'bg-rose-600' : 'bg-primary-600'} p-8 relative transition-colors`}>
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center text-white text-2xl font-black backdrop-blur-md border border-white/20 shadow-inner overflow-hidden">
