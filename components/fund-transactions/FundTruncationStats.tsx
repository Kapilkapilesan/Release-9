        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            {statCards.map((card, index) => {
                ...
                return (
                    <div
                        key={index}
                        className="group relative bg-card h-full min-h-[140px] px-6 py-5 rounded-[2rem] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-border-default overflow-hidden"
                    >
